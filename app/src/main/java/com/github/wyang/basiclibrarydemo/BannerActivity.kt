...
import com.github.wyang.basiclibrarydemo.databinding.ActivityBannerBinding

open class BannerActivity : BaseActivity<ActivityBannerBinding>() {

    override fun getViewBinding(): ActivityBannerBinding {
    ...
    override fun initialize() {
        ...
        mBinding?.bl01?.setBannerAdapter(adapter)
        ...
        mBinding?.bl02?.setBannerAdapter(adapter2)
    }

    private val adapter: BannerAdapter<String> = object : BannerAdapter<String>(R.layout.item_banner_img) {
        override fun convert(helper: BannerViewHolder, item: String) {
            GlideImageLoader.loadCenterCrop(mContext, helper.getView(R.id.iv_banner), item)
        }
    }

    private val adapter2: BannerAdapter<String> = object : BannerAdapter<String>(R.layout.item_banner_tv) {
        override fun convert(helper: BannerViewHolder, item: String) {
