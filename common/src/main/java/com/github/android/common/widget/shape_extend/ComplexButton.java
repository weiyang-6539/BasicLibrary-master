 ...
 */
public class ComplexButton extends AppCompatButton {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            cvSelector = typedArray.getInt(R.styleable.ComplexButton_cvSelector, cvSelector);

            cvNormalBgColor = typedArray.getColor(R.styleable.ComplexButton_cvNormalBgColor, cvNormalBgColor);
            cvPressedBgColor = typedArray.getColor(R.styleable.ComplexButton_cvPressedBgColor, cvPressedBgColor);
            cvDisableBgColor = typedArray.getColor(R.styleable.ComplexButton_cvDisableBgColor, cvDisableBgColor);

            cvCornersRadius = typedArray.getDimensionPixelSize(R.styleable.ComplexButton_cvCornersRadius, 0);
            cvCornersTopLeftRadius = typedArray.getDimensionPixelSize(R.styleable.ComplexButton_cvCornersTopLeftRadius, 0);
            cvCornersTopRightRadius = typedArray.getDimensionPixelSize(R.styleable.ComplexButton_cvCornersTopRightRadius, 0);
            cvCornersBottomLeftRadius = typedArray.getDimensionPixelSize(R.styleable.ComplexButton_cvCornersBottomLeftRadius, 0);
            cvCornersBottomRightRadius = typedArray.getDimensionPixelSize(R.styleable.ComplexButton_cvCornersBottomRightRadius, 0);

            cvStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.ComplexButton_cvStrokeWidth, 0);

            cvStrokeNormalColor = typedArray.getColor(R.styleable.ComplexButton_cvStrokeNormalColor, cvStrokeNormalColor);
            cvStrokePressedColor = typedArray.getColor(R.styleable.ComplexButton_cvStrokePressedColor, cvStrokePressedColor);
            cvStrokeDisableColor = typedArray.getColor(R.styleable.ComplexButton_cvStrokeDisableColor, cvStrokeDisableColor);

            cvGravity = typedArray.getInt(R.styleable.ComplexButton_cvGravity, cvGravity);
            cvElevation = typedArray.getDimensionPixelSize(R.styleable.ComplexButton_cvElevation, 0);
            cvClickable = typedArray.getBoolean(R.styleable.ComplexButton_cvClickable, true);

            cvIconStart = typedArray.getDrawable(R.styleable.ComplexButton_cvIconStart);
            cvIconTop = typedArray.getDrawable(R.styleable.ComplexButton_cvIconTop);
            cvIconEnd = typedArray.getDrawable(R.styleable.ComplexButton_cvIconEnd);
            cvIconBottom = typedArray.getDrawable(R.styleable.ComplexButton_cvIconBottom);

            cvIconStartSize = typedArray.getDimensionPixelSize(R.styleable.ComplexButton_cvIconStartSize, dp2px(cvIconStartSize));
            cvIconTopSize = typedArray.getDimensionPixelSize(R.styleable.ComplexButton_cvIconTopSize, dp2px(cvIconTopSize));
            cvIconEndSize = typedArray.getDimensionPixelSize(R.styleable.ComplexButton_cvIconEndSize, dp2px(cvIconEndSize));
            cvIconBottomSize = typedArray.getDimensionPixelSize(R.styleable.ComplexButton_cvIconBottomSize, dp2px(cvIconBottomSize));

            cvIconStartTint = typedArray.getColorStateList(R.styleable.ComplexButton_cvIconStartTint);
            cvIconTopTint = typedArray.getColorStateList(R.styleable.ComplexButton_cvIconTopTint);
            cvIconEndTint = typedArray.getColorStateList(R.styleable.ComplexButton_cvIconEndTint);
            cvIconBottomTint = typedArray.getColorStateList(R.styleable.ComplexButton_cvIconBottomTint);

            cvIconPadding = typedArray.getDimensionPixelOffset(R.styleable.ComplexButton_cvIconPadding, dp2px(cvIconPadding));
