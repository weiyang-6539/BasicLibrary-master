package com.github.android.common.widget.bottomnavigation.behaviour;
...
//    }
     ...
     * @param currentOverScroll Unconsumed values, negative or positive based on the direction;
     * @param totalScroll       Cumulative values for current direction (Unconsumed)
     */
     ...
     * @param scrollDirection     Direction of the scroll: SCROLL_DIRECTION_UP, SCROLL_DIRECTION_DOWN
     * @param currentOverScroll   Unconsumed values, negative or positive based on the direction;
     * @param totalConsumedScroll Cumulative values for current direction (Unconsumed)
     */
